...
import { chartInstanceState, optionPolarAreaActiveTabState } from '../../../recoil/atoms';
...
function OptionsPolarAreaChart() {
    ...
    const [optionPolarAreaActiveTab, setOptionPolarAreaActiveTab] = useRecoilState(optionPolarAreaActiveTabState);
            ...
            <div className='tab_wrap options_common_wrap'>
                <ul className="nav nav-tabs" role="tablist">
                    <li className="nav-item">
                        <button
                            className={`nav-link ${optionPolarAreaActiveTab === 'pointLabels' ? 'active' : ''}`}
                            onClick={() => setOptionPolarAreaActiveTab('pointLabels')}
                        >
                            pointLabels 설정
                        </button>
                    </li>
                ...
                <div className="tab-content">
                    {optionPolarAreaActiveTab === 'pointLabels' && (
